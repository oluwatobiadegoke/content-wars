...
const Vote = () => {
  return (
    <div className="flex gap-2 lg:gap-0 p-4 lg:p-0 lg:flex-row w-full justify-between bg-lightGrey-100 lg:h-20 rounded">
      <div className="flex gap-6 h-full items-center">
        <div className="h-10 w-10 rounded-full overflow-hidden flex justify-center items-center">
          <Image src="/war1.png" alt="" height={40} width={40} />
        </div>
